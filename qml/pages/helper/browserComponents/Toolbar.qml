    ...
    IconButton {
        ...
        onPositionChanged: {
            if (fPage.extraToolbar.opacity == 1 && fPage.extraToolbar.quickmenu && mouse.y > ((fPage.extratoolbarheight + fPage.toolbarheight) * -1)) {
                ...
                if (mouse.x > fPage.extraToolbar.newTabButton.x && mouse.x < fPage.extraToolbar.nightModeButton.x) { fPage.extraToolbar.minimizeButton.highlighted = false; fPage.extraToolbar.newTabButton.highlighted = true; fPage.extraToolbar.nightModeButton.highlighted = false; fPage.extraToolbar.closeTabButton.highlighted = false; fPage.extraToolbar.orientationLockButton.highlighted = false; fPage.extraToolbar.readerModeButton.highlighted = false; fPage.extraToolbar.searchModeButton.highlighted = false; fPage.extraToolbar.shareButton.highlighted = false; }
                else if (mouse.x < fPage.extraToolbar.newTabButton.x) {fPage.extraToolbar.minimizeButton.highlighted = true; fPage.extraToolbar.newTabButton.highlighted = false; fPage.extraToolbar.nightModeButton.highlighted = false; fPage.extraToolbar.closeTabButton.highlighted = false; fPage.extraToolbar.orientationLockButton.highlighted = false; fPage.extraToolbar.readerModeButton.highlighted = false; fPage.extraToolbar.searchModeButton.highlighted = false; fPage.extraToolbar.shareButton.highlighted = false; }
                else if (mouse.x > fPage.extraToolbar.nightModeButton.x && mouse.x < fPage.extraToolbar.closeTabButton.x) { fPage.extraToolbar.minimizeButton.highlighted = false; fPage.extraToolbar.newTabButton.highlighted = false; fPage.extraToolbar.nightModeButton.highlighted = true; fPage.extraToolbar.closeTabButton.highlighted = false; fPage.extraToolbar.orientationLockButton.highlighted = false; fPage.extraToolbar.readerModeButton.highlighted = false; fPage.extraToolbar.searchModeButton.highlighted = false; fPage.extraToolbar.shareButton.highlighted = false; }
                else if (mouse.x > fPage.extraToolbar.closeTabButton.x && mouse.x < fPage.extraToolbar.orientationLockButton.x) { fPage.extraToolbar.minimizeButton.highlighted = false; fPage.extraToolbar.newTabButton.highlighted = false; fPage.extraToolbar.nightModeButton.highlighted = false; fPage.extraToolbar.closeTabButton.highlighted = true; fPage.extraToolbar.orientationLockButton.highlighted = false; fPage.extraToolbar.readerModeButton.highlighted = false; fPage.extraToolbar.searchModeButton.highlighted = false; fPage.extraToolbar.shareButton.highlighted = false; }
                else if (mouse.x > fPage.extraToolbar.orientationLockButton.x && mouse.x < fPage.extraToolbar.orientationLockButton.x + fPage.extraToolbar.orientationLockButton.width + Theme.paddingMedium) { fPage.extraToolbar.minimizeButton.highlighted = false; fPage.extraToolbar.newTabButton.highlighted = false; fPage.extraToolbar.nightModeButton.highlighted = false; fPage.extraToolbar.closeTabButton.highlighted = false; fPage.extraToolbar.orientationLockButton.highlighted = true; fPage.extraToolbar.readerModeButton.highlighted = false; fPage.extraToolbar.searchModeButton.highlighted = false; fPage.extraToolbar.shareButton.highlighted = false; }
                else if (mouse.x > fPage.extraToolbar.readerModeButton.x && mouse.x < fPage.extraToolbar.readerModeButton.x + fPage.extraToolbar.readerModeButton.width + Theme.paddingMedium) { fPage.extraToolbar.minimizeButton.highlighted = false; fPage.extraToolbar.newTabButton.highlighted = false; fPage.extraToolbar.nightModeButton.highlighted = false; fPage.extraToolbar.closeTabButton.highlighted = false; fPage.extraToolbar.orientationLockButton.highlighted = false; fPage.extraToolbar.readerModeButton.highlighted = true; fPage.extraToolbar.searchModeButton.highlighted = false; fPage.extraToolbar.shareButton.highlighted = false; }
                else if (mouse.x > fPage.extraToolbar.searchModeButton.x && mouse.x < fPage.extraToolbar.searchModeButton.x + fPage.extraToolbar.searchModeButton.width + Theme.paddingMedium) { fPage.extraToolbar.minimizeButton.highlighted = false; fPage.extraToolbar.newTabButton.highlighted = false; fPage.extraToolbar.nightModeButton.highlighted = false; fPage.extraToolbar.closeTabButton.highlighted = false; fPage.extraToolbar.orientationLockButton.highlighted = false; fPage.extraToolbar.readerModeButton.highlighted = false; fPage.extraToolbar.searchModeButton.highlighted = true; fPage.extraToolbar.shareButton.highlighted = false;}
                else if (mouse.x > fPage.extraToolbar.shareButton.x && mouse.x < fPage.extraToolbar.shareButton.x + fPage.extraToolbar.shareButton.width + Theme.paddingMedium) { fPage.extraToolbar.minimizeButton.highlighted = false; fPage.extraToolbar.newTabButton.highlighted = false; fPage.extraToolbar.nightModeButton.highlighted = false; fPage.extraToolbar.closeTabButton.highlighted = false; fPage.extraToolbar.orientationLockButton.highlighted = false; fPage.extraToolbar.readerModeButton.highlighted = false; fPage.extraToolbar.searchModeButton.highlighted = false; fPage.extraToolbar.shareButton.highlighted = true; }
                else if (mouse.x > fPage.extraToolbar.shareButton.x + fPage.extraToolbar.shareButton.width + Theme.paddingMedium) { fPage.extraToolbar.minimizeButton.highlighted = false; fPage.extraToolbar.newTabButton.highlighted = false; fPage.extraToolbar.nightModeButton.highlighted = false; fPage.extraToolbar.closeTabButton.highlighted = false; fPage.extraToolbar.orientationLockButton.highlighted = false; fPage.extraToolbar.readerModeButton.highlighted = false; fPage.extraToolbar.searchModeButton.highlighted = false; fPage.extraToolbar.shareButton.highlighted = false; }
            }
            if (mouse.y < ((fPage.extratoolbarheight + fPage.toolbarheight) * -1)) {
                ...
                fPage.extraToolbar.nightModeButton.highlighted = false;
...
//                    }
        ...
        onReleased: {
            ...
            else if (fPage.extraToolbar.opacity == 1 && fPage.extraToolbar.quickmenu && fPage.extraToolbar.nightModeButton.highlighted == true) fPage.extraToolbar.nightModeButton.clicked(undefined)
